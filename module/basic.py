...
class BasicBlock(nn.Module):
	...
	def __init__(self, in_ch, out_ch, stride=1, downsample=None, dilation=1):
		...
		self.conv1 = Conv2dBnRelu(in_ch, out_ch, kernel_size=3, stride=stride, padding=dilation, dilation=dilation, bias=False)
		
		self.conv2 = Conv2dBn(in_ch, out_ch, kernel_size=3, stride=1, padding=dilation, dilation=dilation, bias=False)
...
class Bottleneck(nn.Module):
	...
	def __init__(self, in_ch, out_ch, stride=1, downsample=None, dilation=1):
		...
		self.conv2 = Conv2dBnRelu(out_ch, out_ch, kernel_size=3, stride=stride, padding=dilation, dilation=dilation, bias=False)
